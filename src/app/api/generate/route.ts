...

{
  ...
  "prerequisites": {
    ...
    "difficultyLevel": 3,
    "difficultyBarriers": ["この本を読む上で具体的にぶつかる壁・ハードルを3〜5項目で箇条書き。抽象的な分類（『専門用語が多い』）ではなく、この本固有の具体的な障壁を書くこと（例：『18世紀フランスの政治体制を知らないと第2章以降の議論が追えない』『微分方程式が頻出し、数式を読み飛ばすと論旨を見失う』『著者独自の造語が多く、定義を覚えながら読む必要がある』）。壁がほぼない入門書でも『特になし。丁寧な語り口で予備知識なしで読める』のように1項目は返すこと"],
    "terminology": [
